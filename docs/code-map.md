...
| How a drawing settles when something is moved or a value is typed | `sketch/src/sketch/settling.rs` | `Sketch::settle_around`, `settle_around_all`, `resolve`, `would_be_redundant` |
