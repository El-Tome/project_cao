...
| What the measure tool reads off a target, the offsets included | `sketch/src/reading.rs` | `Sketch::read`, `Reading` |
...
| Canvas: the dashed run a measure is drawn as, and the numbers beside it | `app/src/screens/viewport/render/reading.rs` | `push_measure`, `paint_measure` |
...
| What a measure says, on one line per number | `app/src/wording/measure.rs` | `lines` |
