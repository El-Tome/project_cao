...
pub fn label(lang: &Catalogue, command: Command) -> String {
    lang.t(match command {
        ...
        Command::ToolEllipse => "command.label.tool_ellipse",
        Command::ToolPoint => "command.label.tool_point",
        Command::ToolDimension => "command.label.tool_dimension",
        Command::ToolMeasure => "command.label.tool_measure",
        ...
        Command::EllipseByCentre => "command.label.ellipse_by_centre",
        Command::EllipseByEnds => "command.label.ellipse_by_ends",
...
pub fn hint(lang: &Catalogue, command: Command) -> String {
    lang.t(match command {
        ...
        Command::ToolEllipse => "command.hint.tool_ellipse",
        Command::ToolPoint => "command.hint.tool_point",
        Command::ToolDimension => "command.hint.tool_dimension",
        Command::ToolMeasure => "command.hint.tool_measure",
        ...
        Command::EllipseByCentre => "command.hint.ellipse_by_centre",
        Command::EllipseByEnds => "command.hint.ellipse_by_ends",
...
pub fn family_heading(lang: &Catalogue, family: CommandFamily) -> String {
    lang.t(match family {
        ...
        CommandFamily::Ellipses => "command.family.ellipses",
