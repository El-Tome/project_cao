...
//! `MergePoints` say how a shape was reached, not what it is; erased elements
//! and their `EraseMany` leave nothing once the erasing is done. Compaction
//! drops all of that and re-emits
