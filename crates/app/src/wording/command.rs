...
pub fn label(lang: &Catalogue, command: Command) -> String {
    lang.t(match command {
        ...
        Command::CompactHistory => "command.label.compact_history",
        Command::ToolSelect => "command.label.tool_select",
        Command::ToolLine => "command.label.tool_line",
        Command::ToolLineSymmetric => "command.label.tool_line_symmetric",
        Command::ToolRectangle => "command.label.tool_rectangle",
        Command::ToolCircle => "command.label.tool_circle",
        Command::ToolArc => "command.label.tool_arc",
        Command::ToolPoint => "command.label.tool_point",
        Command::ToolDimension => "command.label.tool_dimension",
        Command::ToolTrim => "command.label.tool_trim",
        Command::ToolSplit => "command.label.tool_split",
        Command::ToolChamfer => "command.label.tool_chamfer",
        Command::ToolFillet => "command.label.tool_fillet",
        Command::ToolMirror => "command.label.tool_mirror",
        Command::ToolCircularPattern => "command.label.tool_circular_pattern",
        Command::ToolRectangularPattern => "command.label.tool_rectangular_pattern",
        ...
        Command::ArcByCenter => "command.label.arc_by_center",
        Command::ArcByEnds => "command.label.arc_by_ends",
        Command::ChamferEqual => "command.label.chamfer_equal",
        Command::ChamferAngled => "command.label.chamfer_angled",
        Command::ChamferSided => "command.label.chamfer_sided",
        ...
        Command::ToggleExplorer => "command.label.toggle_explorer",
...
pub fn hint(lang: &Catalogue, command: Command) -> String {
    lang.t(match command {
        ...
        Command::CompactHistory => "command.hint.compact_history",
        Command::ToolSelect => "command.hint.tool_select",
        Command::ToolLine => "command.hint.tool_line",
        Command::ToolLineSymmetric => "command.hint.tool_line_symmetric",
        Command::ToolRectangle => "command.hint.tool_rectangle",
        Command::ToolCircle => "command.hint.tool_circle",
        Command::ToolArc => "command.hint.tool_arc",
        Command::ToolPoint => "command.hint.tool_point",
        Command::ToolDimension => "command.hint.tool_dimension",
        Command::ToolTrim => "command.hint.tool_trim",
        Command::ToolSplit => "command.hint.tool_split",
        Command::ToolChamfer => "command.hint.tool_chamfer",
        Command::ToolFillet => "command.hint.tool_fillet",
        Command::ToolMirror => "command.hint.tool_mirror",
        Command::ToolCircularPattern => "command.hint.tool_circular_pattern",
        Command::ToolRectangularPattern => "command.hint.tool_rectangular_pattern",
        ...
        Command::ArcByCenter => "command.hint.arc_by_center",
        Command::ArcByEnds => "command.hint.arc_by_ends",
        Command::ChamferEqual => "command.hint.chamfer_equal",
        Command::ChamferAngled => "command.hint.chamfer_angled",
        Command::ChamferSided => "command.hint.chamfer_sided",
        ...
        Command::ToggleExplorer => "command.hint.toggle_explorer",
...
pub fn family_heading(lang: &Catalogue, family: CommandFamily) -> String {
    lang.t(match family {
        ...
        CommandFamily::Arcs => "command.family.arcs",
        CommandFamily::Chamfers => "command.family.chamfers",
