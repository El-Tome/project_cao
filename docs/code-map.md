...
| A field that completes a variable's name from a list under it | `app/src/ui/formula_field.rs`, `app/src/screens/variables/mod.rs` | `formula_field`, `keeps_escape`; `offered`, `NAMING` |
